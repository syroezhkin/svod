...
export class CommandResult {
    ...
    get text() {
        ...
        try {
            ...
            wasm.commandresult_text(retptr, this.__wbg_ptr);
     ...
     */
    get clear() {
        const ret = wasm.__wbg_get_commandresult_clear(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get quit() {
        const ret = wasm.__wbg_get_commandresult_quit(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * Whether the frontend should clear the terminal output.
     ...
     */
    set clear(arg0) {
        wasm.__wbg_set_commandresult_clear(this.__wbg_ptr, arg0);
    }
    /**
     * Whether the frontend should end the session (reload the page).
     * @param {boolean} arg0
     */
    set quit(arg0) {
        wasm.__wbg_set_commandresult_quit(this.__wbg_ptr, arg0);
    }
}
if (Symbol.dispose) CommandResult.prototype[Symbol.dispose] = CommandResult.prototype.free;
...
export class Svod {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SvodFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_svod_free(ptr, 0);
    }
    /**
    ...
    command(input) {
        ...
        const ret = wasm.svod_command(this.__wbg_ptr, ptr0, len0);
    ...
    highlight(code) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.svod_highlight(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred2_0 = r0;
            deferred2_1 = r1;
    ...
    interpret(code) {
        const ptr0 = passStringToWasm0(code, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.svod_interpret(this.__wbg_ptr, ptr0, len0);
    ...
    queue_input(text) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.svod_queue_input(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    reset_input() {
        wasm.svod_reset_input(this.__wbg_ptr);
    }
    /**
    ...
    set_lang(lang) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.svod_set_lang(this.__wbg_ptr, ptr0, len0);
    }
}
if (Symbol.dispose) Svod.prototype[Symbol.dispose] = Svod.prototype.free;
...
export class SvodOutput {
    static __wrap(ptr) {
        const obj = Object.create(SvodOutput.prototype);
        obj.__wbg_ptr = ptr;
        SvodOutputFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SvodOutputFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
    ...
    get output() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.svodoutput_output(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    get pending_prompt() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.svodoutput_pending_prompt(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
...
if (Symbol.dispose) SvodOutput.prototype[Symbol.dispose] = SvodOutput.prototype.free;
 ...
 * @returns {string}
 */
export function welcome_text() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.welcome_text(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./svod_web_bg.js": import0,
    };
}

const CommandResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_commandresult_free(ptr, 1));
const SvodFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_svod_free(ptr, 1));
const SvodOutputFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_svodoutput_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('svod_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
